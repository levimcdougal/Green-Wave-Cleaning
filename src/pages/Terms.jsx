...
const sections = [
  ...
  },
  {
    ...
    content: `We request at least 48 hours' notice for cancellations or rescheduling.\n\nFailure to provide proper notice may result in:\n• A cancellation fee\n• Partial service charge\n• Full service charge for same-day cancellations or inaccessible properties\n\nIf we are unable to access the property at the scheduled time, the appointment may be canceled and charged accordingly.`,
  },
  {
